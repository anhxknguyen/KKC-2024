...
const AnswerPage = ({ params }: { params: { answer: string } }) => {
  ...
  const correctMessage: string =
    "ouuhhh...is jas kit..the cat allows u to pass.";
  const wrongMessage: string =
    "wrong choice!! u get beat up and mast apologize..";
  ...
  if (params.answer == "correct") {
    return (
      <div className="flex flex-col h-full justify-center items-center gap-2">
        <img src="/correct-q2.jpeg" className="h-2/3" />
        <div
  ...
  return (
    <div className="flex flex-col h-full justify-center items-center gap-2">
      <img src="/wrong-q2.gif" className="h-2/3" />
